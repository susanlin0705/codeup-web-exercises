...
alert("You make " + paycheck.toFixed(2) + " dollars this week.");
...
// var purchase = confirm("Have you purchased more than 2 items?");
var item= prompt("how many have you purchased?");
//
// alert("yes " + member||premium && offer);

alert(member&&Number(item>=2)||premium&&offer);
